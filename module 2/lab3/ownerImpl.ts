...
export class OwnerImpl implements Owner {
    ...
    set Birth(birth: Date) { this._birth = birth ;}
    get Birth() { return this._birth; }
    set Doc(doc: doc_t) { this._doc = doc ;}
    get Doc() { return this._doc; }
    set Doc_serial(doc_serial: number) { this._doc_serial = doc_serial ;}
    get Doc_serial() { return this._doc_serial; }
    set Doc_num(doc_num: number) { this._doc_num = doc_num ;}
    get Doc_num() { return this._doc_num; }
